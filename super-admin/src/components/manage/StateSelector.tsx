...
const StateSelector: React.FC<StateSelectorProps> = ({ value, onChange, className }) => {
    ...
    return (
        <div className={`relative ${className}`} ref={dropdownRef}>
            ...
            {/* Dropdown Menu */}
            {isOpen && (
                <div className="absolute z-[9999] top-[calc(100%+4px)] left-0 w-full min-w-[200px] bg-white rounded-xl border border-slate-200 shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-100 flex flex-col">
