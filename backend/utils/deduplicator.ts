 ...
 */
export function deduplicateData(data: any[]): DeduplicationResult {
    if (!Array.isArray(data) || data.length === 0) {
        return { unique: data || [], duplicates: [], stats: { total: 0, unique: 0, duplicates: 0, deduplicationRate: 0 } };
    }
 ...
 */
export function deduplicateWithLogging(data: any[], fileName: string = 'file'): DeduplicationResult {
 ...
 */
export function deduplicateByFields(data: any[], fields: string[]): DeduplicationResult {
    if (!Array.isArray(data) || data.length === 0) {
        return { unique: data || [], duplicates: [], stats: { total: 0, unique: 0, duplicates: 0, deduplicationRate: 0 } };
    }
