...
interface MergeResult {
    data: any;
    status: 'pending' | 'conflict' | 'confirmed';
    incomingData?: any;
    history?: any[];
    [key: string]: any;
}

export const fetchAndParseSheet = async (url: string): Promise<any[]> => {
    try {
...
export const filterRecords = (records: any[], filters: FilterCriteria): any[] => {
...
export const mergeRecords = (existingRecords: any[], cloudRecords: any[]): MergeResult[] => {
    // Unified Logic: 
