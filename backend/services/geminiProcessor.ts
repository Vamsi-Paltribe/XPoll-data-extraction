...
export async function processPdfWithGemini(pdfBuffer: Buffer): Promise<any> {
    try {
...
`;
        ...
        const totalRecords = Object.values(extractedData).reduce((sum: number, records: any) => sum + records.length, 0);
